...
public class TargetDetails implements Parcelable {
    ...
    private String name,type,address,placeId;
    private double[] current = new double[2],target = new double[2];
    private double radius;

    TargetDetails(String name,String type,String address,double[] current,double[] target,String placeId)
    {
        this.name = name;
        this.type = type;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeStringArray(new String[]{this.name,this.type,this.address,this.placeId});
