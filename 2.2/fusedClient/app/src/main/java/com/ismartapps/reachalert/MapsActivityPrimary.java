...
public class MapsActivityPrimary extends FragmentActivity implements OnMapReadyCallback {
    ...
    private ImageView mCurrLoc, mLocationTick;
    ...
    private void init(){
        ...
        mLocationTick.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            ...
            if(checkPermissions()) {
                ...
                location.addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        ...
                        movecamera(new LatLng(currentLocation.getLatitude(),currentLocation.getLongitude()),20f,"Current Location",address,"Point of interest");
                    }
                    else{
