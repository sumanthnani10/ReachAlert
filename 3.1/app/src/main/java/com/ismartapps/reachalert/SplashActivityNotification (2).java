...
public class SplashActivityNotification extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("Last Used").child(sharedPreferences.getString("name", "User Name")).child("Notification Clicked").setValue(DateFormat.getDateTimeInstance().format(new Date()));
