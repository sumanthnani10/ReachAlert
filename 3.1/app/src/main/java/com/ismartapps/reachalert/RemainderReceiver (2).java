...
public class RemainderReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        databaseReference.child("Last Used").child(sharedPreferences.getString("name", "User Name")).child("Notified").setValue(DateFormat.getDateTimeInstance().format(new Date()));
    }
}
