...
public class MapsActivityPrimary extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void init(){
        ...
        mLocationTick.setOnClickListener(v -> {
            ...
            targetDetails = new TargetDetails(targetPlaceName.getText().toString(),targetPlaceType.getText().toString(),targetPlaceAddress.getText().toString(),new double[]{currentLocationLatlng.latitude,currentLocationLatlng.longitude},new double[]{targetLatLng.latitude,targetLatLng.longitude});
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch(menuItem.getItemId())
                {
                    case R.id.share:
                        ...
                        sendIntent.putExtra(Intent.EXTRA_TEXT, "Alert yourselves as soon as you reach your destination by using Reach Alert.\n\n - https://play.google.com/store/apps/details?id=com.ismartapps.reachalert");
