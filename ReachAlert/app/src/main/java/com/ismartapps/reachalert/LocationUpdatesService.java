...
public class LocationUpdatesService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        else startForeground(NOTIFICATION_ID, getNotification(current));
    ...
    private Notification getNotification(LatLng latLng) {
        ...
        CharSequence text = Utils.getLocationText(name,getDistance(latLng),this);
    ...
    public void setTarget(LatLng target,double radius,String name)
    {
        Log.d(TAG, "setTarget");
        this.target = target;
    ...
    public void setRadius(double radius,String name) {
        Log.d(TAG, "setRadius");
        this.radius = radius;
        setName(name);
    }
    ...
    public void setActivity(Activity activity,LatLng target,double radius,String name){
        this.activity=activity;
        setTarget(target,radius,name);
    }
}